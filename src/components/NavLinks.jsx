    ...
    return (
        <div className='flex justify-center items-center '>
            ...
            <div className=" px-4 py-6 bg-black bg-opacity-20 justify-between items-center inline-flex xl:w-[80%]  w-[90%] max-md:hidden">
                    ...
                    <Link to="/gallery" className="text-center text-white text-xl max-xl:text-base max-lg:text-sm font-normal font-['Poppins']">GALLERY</Link> 
                <Link to="/"   className="text-center text-white text-[32px] max-lg:text-lg font-normal tracking-[0.1em] font-['Poppins']">BJ Barango <br/></Link>
                    ...
                    <Link to="/backyardrave"  className="text-center text-white text-xl max-xl:text-base max-lg:text-sm font-normal font-['Poppins']">SHOP</Link>
            </div>
        </div>
    )
}
