        ...
        <div className='min-h-screen w-full p-0'>
            ...
            <div className="  w-full flex flex-col pt-10 bg-black">
                ...
                <div className='px-20 pb-16'>
                    <div className="text-white text-[32px] font-normal font-['Poppins'] mt-20">Let's Connect and Create Something Extraordinary!</div>
                ...
                <div className='border-y border-white '>
                    <div className='ml-56 mr-10 w-2/3 my-16 '>
