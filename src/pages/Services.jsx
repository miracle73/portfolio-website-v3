        ...
        <div className='min-h-screen w-full p-0'>
            ...
            <div className="  w-full flex flex-col pt-10 bg-black ">
                ...
                <div className='flex items-start justify-between px-16 mt-10 '>
                    <div className='w-[45%] '>
                        <div className=" text-white text-[24px] font-normal font-['Javanese Text']">Event Hosting</div>
                    ...
                    <div className='w-[45%] '>
                        <div className=" text-white text-[24px] font-normal font-['Javanese Text']">Content Creation</div>
                ...
                <div className='flex items-start justify-between px-16 mt-14 '>
                    <div className='w-[45%] '>
                        <div className=" text-white text-[24px] font-normal font-['Javanese Text']">Marketing & Promotion</div>
                    ...
                    <div className='w-[45%] '>
                        <div className=" text-white text-[24px] font-normal font-['Javanese Text']">Media Production</div>
